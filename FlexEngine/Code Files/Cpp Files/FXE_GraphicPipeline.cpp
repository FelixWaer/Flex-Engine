...
void FXEGraphicPipeline::cleanup(VkDevice device)
{
...
void FXEGraphicPipeline::create_GraphicsPipeline(VkDevice device, VkDescriptorSetLayout& descriptorSetLayout)
{
    ...
    VkShaderModule vertShaderModule = create_ShaderModule(device, vertShaderCode);
    VkShaderModule fragShaderModule = create_ShaderModule(device, fragShaderCode);
...
void FXEGraphicPipeline::create_RenderPass(VkDevice device, VkFormat swapChainImageFormat)
{
...
VkShaderModule FXEGraphicPipeline::create_ShaderModule(VkDevice device, const std::vector<char>& data)
{
...
//Method for reading through the vertices files and copying the data so the graphics pipeline can use it to render the image
std::vector<char> FXEGraphicPipeline::readFile(const char* filename)
{
